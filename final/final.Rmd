...
<!-- ============================== NOTLAR ================================= -->
<!-- ======================================================================= -->
[^1]: 21080560, [Github Repo](https://github.com/basakaaydin/Final)
...
# Veri 
Bu çalışmamda kullandığım veri setini UCI Machine Learning Repository sitesinden alıp excel dosyasına aktardım.

```{r}
library(tidyverse)
library(here)
adult <- read_csv(here("adult.data.csv"))
```
...
survey %>%
  select("race", "sex", "Education", "hours per week", "yearly income") %>% 
